 ...
 * {@link #$nullsafe(Object, Object)}, which
 * can be implemented without any regard to possible null-pointers.
 *
 * @see Fn2
 */
public abstract class NullIfEitherArgIsNullOrElse<I1, I2, O> implements Fn2<I1, I2, O> {

    @Override
    public O $(I1 first, I2 second) {
        return (first == null || second == null) ? null : $nullsafe(first, second);
    }
     ...
     */
    protected abstract O $nullsafe(I1 first, I2 second);
